...
def main() -> None:
    ...
    try:
        if args.backtest:
            ...
            decisions = run_daemon(settings, args.interval_seconds, args.fixture_code, args.window, use_synthetic_fixtures=args.use_synthetic_fixtures, verbose=args.verbose, max_iterations=args.max_iterations, use_llm_analyst=args.use_llm_analyst, use_llm_claims=args.use_llm_claims)
        else:
            decisions = run_once(settings, args.fixture_code, args.window, use_synthetic_fixtures=args.use_synthetic_fixtures, verbose=args.verbose, use_llm_analyst=args.use_llm_analyst, use_llm_claims=args.use_llm_claims)
