...
FOUR_AGENT_ARCHITECTURE_ENABLED: bool = _env_bool("FOUR_AGENT_ARCHITECTURE_ENABLED", True)
MONK_INDEPENDENT_ENABLED: bool = _env_bool("MONK_INDEPENDENT_ENABLED", True)
...
DETERMINISTIC_HT_ENABLED: bool = _env_bool("DETERMINISTIC_HT_ENABLED", True)
AGENT_SPECIFIC_LEDGER_ENABLED: bool = _env_bool("AGENT_SPECIFIC_LEDGER_ENABLED", True)
